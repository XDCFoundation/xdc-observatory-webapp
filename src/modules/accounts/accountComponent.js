              ...
              <TableHead>
                <TableRow>
                  <TableCell
                    ...
                    align="left"
                  >
                    <span className={"tableheaders_1"}>Address</span>
                  </TableCell>
                  <TableCell
                    style={{ border: "none", paddingLeft: "2.2%" }}
                    align="left"
                  ...
                  <TableCell
                    style={{ border: "none", paddingLeft: "4.4%" }}
                    align="left"
                  >
                          ...
                          >
                            ...
                            >
                              <span className="tabledata">
                                {row.accountType == 0 ? "Account" : "Contract"}
                              </span>
                            </TableCell>
                            <TableCell
                              className="w-3"
                            ...
                            <TableCell
                              className="w-4"
                              style={{ border: "none", paddingLeft: "3.9%" }}
                              align="left"
                            >
                              <span className="tabledata">
                                {" "}
                                &nbsp;
                                {((finalBal / props.state.totalSupply) * 100)
                                  .toString()
                                  .substr(0, 7)}
                                %
                              </span>
        ...
        <Grid container style={{ marginTop: "35px" }} className="Pagination">
          ...
          <Grid item className="Pagination_2">
            ...
            <button id="btn_12" className="btn">
              Page{" "}
              {Math.round(state.totalAccounts / state.amount) +
                1 -
                Math.round(
                  (state.totalAccounts - state.from) / state.amount
                )}{" "}
              of {Math.round(state.totalAccounts / state.amount)}
            </button>
            <button
              id="btn_12"
