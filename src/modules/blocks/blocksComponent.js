            ...
            <TableHead>
              <TableRow>
                <TableCell
                  ...
                  align="left"
                >
                  <span className={"tableheaders"}>Hash</span>
                </TableCell>
                <TableCell
                  style={{ border: "none", paddingLeft: "2%" }}
                  align="left"
                >
                  <span className={"tableheaders"}>Height</span>
                </TableCell>
                <TableCell
                ...
                <TableCell
                  ...
                  align="left"
                >
                  <span className={"tableheaders"}>Transactions</span>
                </TableCell>
                <TableCell
                  style={{ border: "none", paddingLeft: "1.8%" }}
                  align="left"
                >
                  <span className={"tableheaders"}>Difficulty</span>
                </TableCell>
                <TableCell
                  style={{ border: "none", paddingLeft: "1.8%" }}
                  align="left"
                >
                  <span className={"tableheaders"}>Gas Used</span>
                </TableCell>
