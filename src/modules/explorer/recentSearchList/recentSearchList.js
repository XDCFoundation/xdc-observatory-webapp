...
const RecentSearchList = (props) => {
  ...
  return (
    <MainContainer theme={props.theme}>
      <TitleRow>
        <Title theme={props.theme}>{"Recent Searches"}</Title>
          ...
          >
            {dataList?.length > 0 &&
              dataList.map((obj, index) => (
                <ItemContainer theme={props.theme} key={index}>
                  <Row style={{ alignItems: "center" }}>
                    ...
                    >
                      <SearchValue theme={props.theme}>
                        {shorten(obj.searchValue)}
                      </SearchValue>
                      <ResultValue theme={props.theme}>
                        {getAmount(obj.result)}
                      </ResultValue>
                      <RedirectIcon
                        src={"/images/up-arrow-recent-search.svg"}
                      />
                      <ActiveRedirectIcon
