...
<div className={classes.root}>
      <AppBar position="static"  className={classes.appbar}>
        <Tabs value={value} onChange={handleChange}  aria-label="simple tabs example">
          <Tab label="My Watchlist" onClick={handleClickOpen} style={{color:"#2149b9"}}className={classes.mywatch} {...a11yProps(0)} />
                ...
                <TableHead >
                        <TableRow >
                            ...
                            <input class="form-check-input" type="checkbox" id="checkboxNoLabel" value="" aria-label="..."></input>
                                <span className={"tableheaders"}>Address11</span></TableCell>
