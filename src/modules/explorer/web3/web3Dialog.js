...
function Web3Dialog(props) {
    ...
    >
        <div className="main-box">
            ...
            <Row className="card-box" style={{flexFlow: "wrap", paddingTop: '22px', marginBottom: '20px'}}>
                <div className="card margin-right-34px p-t-10">
                    <div className="fs-14 color-9fa9ba" style={{textAlign: 'center'}}>
                        Step 1
                    </div>
                    <img alt="new-feature"
                         src={"/images/xdc-icon-blue-color.svg"}
                         className="web3-dialog-icon"
                    />
                    <div className="card-title">Install XDCPay</div>
                    <div className="card-text color-585858">
                ...
                <div className="card margin-right-34px p-t-10">
                    ...
                    <img alt="new-feature"
                         ...
                         className="web3-dialog-wallet-icon"
                    />
                    <div className="card-title">Login to XDCPay</div>
                    <div className="card-text color-585858">
