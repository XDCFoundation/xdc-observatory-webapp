                        ...
                        <TableHead>
                            <TableRow>
                                <TableCell style={{border: "none"}} align="left"><span
                                    className={"tableheaders"}>TxnHash</span></TableCell>
                                <TableCell style={{border: "none"}} align="left"><span
                                    className={"tableheaders"}>Age</span></TableCell>
                                <TableCell style={{border: "none"}} align="left"><span
                                    className={"tableheaders"}>Block</span></TableCell>
                                <TableCell style={{border: "none"}} align="left"><span
                                    className={"tableheaders"}>From</span></TableCell>
                                <TableCell style={{border: "none"}} align="left"><span
                                    className={"tableheaders"}>To</span></TableCell>
                                ...
                                return (
                                    ...
                                    <StyledTableRow hover role="checkbox" tabIndex={-1} key={row.code}>
                                        ...
                                        <TableCell id="td">
                                            ...
                                            <a style={{color: 'blue', fontSize: 11}} href="#text"><Tooltip placement="top" title={row.TxnHash}><span
                                                className="tabledata"> {shorten(row.TxnHash)} </span></Tooltip> </a>
                                        </TableCell>
                                        <TableCell id="td"><span className="tabledata">{row.Age}</span></TableCell>
                                        <TableCell id="td"> <a style={{color: 'blue', fontSize: 11}} href="#text"><span
                                            className="tabledata"> {row.Block}</span> </a></TableCell>
                                        <TableCell id="td"> <a style={{color: 'blue', fontSize: 11}} href="#text">
                                        <Tooltip placement="top" title={row.From}>
                                        <span
                                            className="tabledata"> {shorten(row.From)} </span>
                                        </Tooltip>
                                         </a></TableCell>
                                        <TableCell id="td"> <a style={{color: 'blue', fontSize: 11}} href="#text">
                                        <Tooltip placement="top" title={row.To}>
                                        <span
                                            className="tabledata"> {shorten(row.To)} </span>
                                        </Tooltip>
                                         </a></TableCell>
