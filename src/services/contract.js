...
export default { getContractLists, getTotalContractList, getContractSearch, getContractDetails, getContractDetailsUsingAddress }


async function getContractDetails(data) {
    let url = process.env.REACT_APP_GET_CONTRACT_DETAILS + data.addr + '?skip=' + Math.ceil((data.pageNum)) + '&limit=' + data.perpage + '&keyword=' + data.keywords;
