...
export default { getUserPrivateNote , postUserPrivateNote}
async function getUserPrivateNote(data) {
    ...
    // console.log("url ",url)
    return httpService("GET", { 'Content-Type': httpConstants.CONTENT_TYPE.APPLICATION_JSON },{}, url)
        .then(
            response => {
...
async function postUserPrivateNote(data) {
    ...
    let url = "http://xinfin-explorer-elb-944849870.us-east-1.elb.amazonaws.com:3002/add-transaction-label";
    console.log("url ",url)
